...
const SOCIAL_ICONS: Record<string, string> = {
  ...
  telegram: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/></svg>',
  pinterest: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="17" y2="22"/><path d="M5 17H3a1 1 0 0 1-1-1v-5a1 1 0 0 1 1-1h2"/><path d="M19 17h2a1 1 0 0 0 1-1v-5a1 1 0 0 0-1-1h-2"/><circle cx="12" cy="10" r="6"/></svg>',
  ...
  threads: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18z"/><path d="M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"/><path d="M12 8v8"/></svg>',
      ...
      .explanatory-video-section h2 {
        ...
        @media (min-width: 768px) {
            .control-grid {
                ...
                grid-auto-rows: 200px; /* 🆕 ALTERADO: Valor intermediário (20% menor que original) */
                gap: 1.5rem;
            }
        ...
        .knowledge-feed-section .knowledge-feed-simple-preview {
          max-width: 600px;
          margin: 0 auto;
        }

        .knowledge-feed-section .carousel-placeholder {
        ...
        .knowledge-feed-section .carousel-icon {
          font-size: 3rem;
          margin-bottom: 1rem;
          opacity: 0.7;
        }

        .knowledge-feed-section .carousel-text {
          color: var(--text-color);
          font-size: 1rem;
          opacity: 0.8;
          line-height: 1.6;
