-- Add unique constraint on user_id for company_profile
ALTER TABLE company_profile ADD CONSTRAINT company_profile_user_id_unique UNIQUE (user_id);

-- Create a default company profile for the current user
